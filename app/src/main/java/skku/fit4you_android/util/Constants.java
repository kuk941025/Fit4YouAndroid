...
public class Constants {
    public static final Class[] Activities = {MainActivity.class, LoginActivity.class, UploadClothingActivity.class, RegisterActivity.class, FollowingManagementActivity.class};
